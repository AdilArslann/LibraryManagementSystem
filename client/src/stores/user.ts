...
export const authUserRole = computed(() =>
  authToken.value ? getUserRoleFromToken(authToken.value) : null
)
...
export const createLibrarian = trpc.user.createLibrarian.mutate
